...
$sql = "SELECT id_publicacion,id_usuario,imagen,descripcion,localizacion,estilo,FechaPublicacion FROM publicacion WHERE id_usuario = $idUsuario ORDER BY FechaPublicacion DESC";
